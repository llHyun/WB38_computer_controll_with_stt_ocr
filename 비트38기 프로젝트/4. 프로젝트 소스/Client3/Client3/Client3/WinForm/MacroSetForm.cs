...
namespace Client3.WinForm
{
    public partial class MacroSetForm : Form
    {
        ...
        private async void Save_btn_Click(object sender, EventArgs e)
        {
            ...
            // 입력된 문자열을 확인하여 특정 단어가 포함되어 있는지 검사
            if (cmdtxt.Contains("선택"))
            {
                MessageBox.Show("중요 호출어 단어가 포함되어 있습니다.");
        ...
        private void KeySet_cb_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            KeySet_btn.Text = KeySet_cb.SelectedItem.ToString();
        }
    }
}
